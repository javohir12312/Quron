    ...
    <>
      {load ? <Loader /> : <div className={style.box}>
        ...
        <ul>
          ...
          <li className={timeStyle == "peshin" ? style.peshin : style.timeLi}>
          ...
          <li className={timeStyle == "asr" ? style.asr : style.timeLi}>
          ...
          <li className={timeStyle == "shom" ? style.shom : style.timeLi}>
            <img src="https://cdn.pixabay.com/photo/2015/04/23/22/00/tree-736885__480.jpg" alt="" />
            <h2>{data.shom_iftor}</h2>
            <h5>Shom | صلاة مساء</h5>
          </li>
          <li className={timeStyle == "xufton" ? style.xufton : style.timeLi}>
